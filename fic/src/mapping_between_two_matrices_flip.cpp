...
namespace reference {
    void mapping_between_two_matrices_with_flip(const int blockDimension, double *x, double *y, double *mapArray) {
        ...
        for(int i = 0; i < 8; i++){
            ...
            map_one_matrix_to_another_with_flip(blockDimension, x, map, vec1);
